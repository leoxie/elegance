define(function() {
     ...
     */
    var template = function(id, content, debug, notSkipCache) {
        if (id && notSkipCache) {
            return template['tpl'].apply(template, arguments);
        } else {
            return template[
            typeof content === 'object' ? 'render' : 'compile'].apply(template, arguments);
        }
    };
    ...
    (function(exports, global) {
        ...
        exports.tpl = function(id, source, debug) {
            var cache = _getCache(id);
            if (cache === undefined) {
                cache = exports.compile(id, source, debug);
            }
            return cache;
        };
        ...
        // ECMA 5 - use strict
        +
            ',arguments,let,yield').split(','), function(key) {
